...
with open('female_train_features_resnet.obj', 'rb') as f:
    train_features = pickle.load(f)
print("Loading training labels")
with open('female_train_labels_resnet.obj', 'rb') as f:
    train_labels = pickle.load(f)

print("Loading validation features")
with open('female_validation_features_resnet.obj', 'rb') as f:
    validation_features = pickle.load(f)
print("Loading validation labels")
with open('female_validation_labels_resnet.obj', 'rb') as f:
...
if not path.exists('femaleClfLinResNew.obj'):
    ...
    with open('femaleClfLinResNew.obj', 'wb') as f:
        pickle.dump(clf, f)
else:
    print('clf exists. Loading...')
    with open('femaleClfLinResNew.obj', 'rb') as f:
        clf = pickle.load(f)
...
for root, dirs, files in list(walk("../femaleTest/"))[4:]:
    if len(files) == 0:
        continue
    print(root)
