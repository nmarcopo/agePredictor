...
with open("male_train_features.obj", "wb") as f:
    pickle.dump(train_features, f)

with open("male_train_labels.obj", "wb") as f:
    pickle.dump(train_labels, f)

with open("male_validation_features.obj", "wb") as f:
    pickle.dump(validation_features, f)

with open("male_validation_labels.obj", "wb") as f:
